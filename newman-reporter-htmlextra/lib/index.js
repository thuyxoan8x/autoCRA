...
PostmanHTMLExtraReporter = function (newman, options, collectionRunOptions) {
	console.log("My log:");
	console.log(options.cmsUiVersion);
	console.log(options);
	console.log("My log:");
    ...
    newman.on('beforeDone', function () {
        ...
        this.exports.push({
            ...
            path: options.export,
            content: compiler({
				cmsUiVersion: options.cmsUiVersion || "",
				cmsCoreVersion: options.cmsCoreVersion || "",
				hapiVersion: options.hapiVersion || "",
				findVersion: options.findVersion || "",
				cloudVersion: options.cloudVersion || "",
